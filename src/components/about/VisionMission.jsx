    ...
    <section ref={ref} className="section-padding bg-deep-ocean relative overflow-hidden">
      <div className="absolute top-0 left-0 right-0">
        <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-12 md:h-20">
          <path fill="#011C40" d="M0,40 C360,0 720,80 1080,40 C1260,20 1380,30 1440,40 L1440,0 L0,0 Z" />
        </svg>
      </div>
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="absolute top-0 left-0 right-0 h-1 rounded-t-2xl bg-gradient-to-r from-luna-light to-luna-medium" />
            <div className="w-14 h-14 rounded-2xl bg-luna-light/10 flex items-center justify-center mb-6">
              <Eye className="w-6 h-6 text-luna-light" />
            </div>
          ...
          <motion.div
            ...
            className="glass-card p-10 relative"
          >
            <div className="absolute top-0 left-0 right-0 h-1 rounded-t-2xl bg-gradient-to-r from-luna-medium to-luna-deep" />
            <div className="w-14 h-14 rounded-2xl bg-luna-medium/10 flex items-center justify-center mb-6">
              <Target className="w-6 h-6 text-luna-medium" />
            </div>
            <h3 className="font-display text-2xl font-bold text-white mb-4">Misi Kami</h3>
            <ul className="space-y-3 text-white/50">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-luna-medium mt-2 flex-shrink-0" />
